...
package top.wyhao.starter.ratelimiter.aop;
...
import top.wyhao.starter.ratelimiter.annotation.RateLimiter;
import top.wyhao.starter.ratelimiter.annotation.RateLimiters;
import top.wyhao.starter.ratelimiter.autoconfigure.RateLimiterProperties;
import top.wyhao.starter.ratelimiter.generator.RateLimiterNameGenerator;
import top.wyhao.starter.ratelimiter.enums.LimitType;
import top.wyhao.starter.ratelimiter.exception.RateLimiterException;
...
public class RateLimiterAspect {
     ...
     * 单个限流注解切点
     */
    @Pointcut("@annotation(top.wyhao.starter.ratelimiter.annotation.RateLimiter)")
     ...
     * 多个限流注解切点
     */
    @Pointcut("@annotation(top.wyhao.starter.ratelimiter.annotation.RateLimiters)")
